        ...
        <main className="flex justify-center items-center h-screen">
            <Tabs defaultValue="account" className="w-[400px]">
                <TabsList className="grid w-full grid-cols-2">
                    <TabsTrigger value="account">Enter OTP</TabsTrigger>
                    <TabsTrigger value="password">New Password</TabsTrigger>
                </TabsList>
                <TabsContent value="account">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                An OTP will be send to your email, enter the otp to change password
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Form {...form}>
