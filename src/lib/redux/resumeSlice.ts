...
export const selectProfile = (state: any) => state.resume.profile;
export const selectWorkExperiences = (state: any) =>
  state.resume.workExperiences;
export const selectEducations = (state: any) => state.resume.educations;
export const selectProjects = (state: any) => state.resume.projects;
export const selectSkills = (state: any) => state.resume.skills;
export const selectCustom = (state: any) => state.resume.custom;
